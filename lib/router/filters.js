...
Router._filters = {
  ...
  */
  ...
  setDescription: function () {
    // if getDescription is set, use it. Otherwise default to site title.
    var description = (typeof this.getDescription === 'function') ? this.getDescription() : getSetting('description');
    var meta = $('meta[name="description"]');
    if (meta.length) {
      meta.attr('content', description);
    } else {
      $('head').append($('<meta>').attr('name', 'description').attr('content', description));
    }
  }
...
Meteor.startup( function (){
  ...
  if(Meteor.isClient){
    ...
    Router.onAfterAction(filters.setDescription);
